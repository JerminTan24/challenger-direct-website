...
const Header = () => {
  return (
    <Navbar className="bg-brand-blue" variant="dark" expand="lg" sticky="top">
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav" className="justify-content-between">
          ...
          <Nav className="mx-auto">
            <Nav.Link href="#store" className="mx-lg-2">Store</Nav.Link>
            <Nav.Link href="#procurement" className="mx-lg-2">Procurement Program</Nav.Link>
            <Nav.Link href="#epp" className="mx-lg-2">Employee Purchase Program</Nav.Link>
            <Nav.Link href="#apple" className="mx-lg-2">Apple Solutions</Nav.Link>
            <Nav.Link href="#login" className="mx-lg-2">Log In</Nav.Link>
          </Nav>
